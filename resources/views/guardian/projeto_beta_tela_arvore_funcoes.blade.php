...
<div class="tree">
    <ul>
        <li>
            <a href="#"><h1>Árvore de funções e permissões</h1></a>
            ...
            <ul>
                <li>
                    ...
                    <!-- permissoes -->
                    <ul>
                        <li><a href="#">Cadastrar gerentes</a></li>
                        <li><a href="#">Alterar gerentes</a></li>
                        <li><a href="#">Visualizar gerentes</a></li>
                        <li><a href="#">Excluir gerentes</a></li>
                    </ul>
                </li>
                <li>
                    <!-- grupos -->
                    ...
                    <ul>
                        ...
                        <li><a href="#">Alterar funcionários</a></li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="#">Alterar produtos</a></li>
